...
const SITE_PASSWORD = 'Nauss2025-2029';
const STORAGE_KEY = 'nauss_site_access';
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4" dir="rtl">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-card border rounded-2xl shadow-xl p-8 space-y-6">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <h1 className="text-xl font-bold text-foreground">الوصول محمي</h1>
          <p className="text-sm text-muted-foreground">يرجى إدخال كلمة المرور للوصول إلى الموقع</p>
        </div>
